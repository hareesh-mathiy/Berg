 ...
 */
public abstract class InteractiveTileObjectPeng {
    ...
    public InteractiveTileObjectPeng(World world, TiledMap map, Rectangle bounds, LevelLoader ll, MapObject object){
        this.world = world;
        this.map = map;
        this.bounds = bounds;
        this.ll = ll;
    ...
    public InteractiveTileObjectPeng(World world, TiledMap map, Shape shape, LevelLoader ll, MapObject object){
        this.world = world;
        this.map = map;
        this.ll = ll;
        this.object = object;
